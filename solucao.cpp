...
int solutionAlgorythm(std::vector<std::vector<std::pair<int, int>>> graph, int currentTower, int edgeCost, bool* visited, std::vector<std::pair<int, bool>> mandatory);
...
int solutionAlgorythm(std::vector<std::vector<std::pair<int, int>>> graph, int currentTower, int edgeCost, bool* visited, std::vector<std::pair<int, bool>> mandatory) {
    ...
    */
    ...
    if (CONTINUESEARCH) {
        ...
        for (std::pair neighbour : graph[currentTower]){    //<--- already sorted by cost
